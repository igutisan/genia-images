...
# @app.post("/edit", summary="Editar imagen existente")
# async def edit_image(
#     prompt: str = Form(...),
...
#             raise HTTPException(
#                 status_code=400, detail="Debes enviar 'image_url' o 'image_base64'."
#             )

#         # Descargar o convertir imagen de entrada
#         if image_url:
...
#             image_path = f"static/{input_filename}"
...
#             input_filename = f"input_{uuid.uuid4().hex}.png"
#             image_path = base64_to_image(image_base64, input_filename)

#         # Ejecutar modelo image-to-image en Replicate
#         output = replicate.run(
#             "stability-ai/stable-diffusion-xl-refiner:latest",
#             input={
...
#         # Descargar la imagen generada desde la URL de Replicate
...
#         return JSONResponse({"success": True, "prompt": prompt, "image_url": image_url})

#     except Exception as e:
#         print(f"❌ Error al editar: {traceback.format_exc()}")
